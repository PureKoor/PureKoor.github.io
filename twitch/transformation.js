...
tx=[`Airy`,`Awkward`,`Angular`, `Amiable`,
    `Bouncy`,`BIG`,`Buff`,`Bulky`,`Bubbly`,
    `Cute`,`Chubby`,`Cozy`,`Clean`,`Clear`,`Cheerful`,`Cold`,`Chunky`, `Chaotic`, `Creative`,
    `Drowzy`,`Defined`,`Damp`,`Dense`,`Dry`,`Deep`,`Durable`,`Diamond`, `Diligent`,
    `Earthy`,`Elastic`,`Enamelled`,`EXTREME`,`Emerald`,
    `Fluffy`,`Firey`,`Firm`,`Flawless`,`Flat`,`Flat Fuck Friday`,`Foamy`,`Furry`,
    `Gooey`,`Glossy`,`Glassy`,`Goopy`,`Gamer`, `Gregarious`,
    `Hazy`,`Hygienic`,
    ...
    `Orderly`,
    `Pointy`,`Polished`,`Puffed Up`,`Perfect`, `Pooltoy-y`,
    `Rubber`,`Reflective`,`Redstone`,`Rough`,`Rested`,
    `ˢᵐᵒˡ`,`Stone`,`Skinny`,`Soft`,`Scaly`,`Snarling`,`Silky`,`Strong`,`Snarling`,`Saturated`,`Smooth`, `Snazzy`, `Space-like`,
    `THICK`,`Thin`,`Taur`, 
    `Undefined`,
    `Pool Toy`,`Pure`,
...
tf=[`Alligator`,`Alpaca`,`Antelope`,`Ape`,`Armadillo`,  `Axolotl`,
    ...
    `Eagle`,`Echidna`,`Elephant`,`Elk`,`Emu`,
    `Fox`,`Falcon`,`Flamingo`, `Fossa`,
    ...
    `Pig`,`Panda`,`Panther`,`Penguin`,`Pigeon`,`Porcupine`, `Armadillo`,
    `Raccoon`,`Raven`,`Reindeer`,`Rhinoceros`,`Rat`,
    `Synth`,`Salamander`,`Sheep`,`Sloth`,`Stoat`, `Red Salmon`,
    `Tiger`,`Tanuki`,`Turkey`,
