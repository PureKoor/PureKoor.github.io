    ...
    <div className="w-full bg-gradient-to-b from-transparent to-[#ffb600] py-5">
      <div className="flex flex-wrap justify-center gap-4 px-4">
        ...
        <Link
          ...
          className="w-20 h-20 rounded-2xl border-4 border-[#4c1a1e] cursor-pointer
        ...
        <a
          ...
          className="w-20 h-20 rounded-2xl border-4 border-[#4c1a1e] bg-[#3b0000] bg-opacity-70
            flex items-center justify-center
            transition-all hover:scale-110 hover:-translate-y-2 hover:border-[#ff424d] duration-300 ease-in-out"
        >
          <FaPatreon className="w-10 h-10 text-white" />
        </a>
        <a
        ...
        >
          <FaBluesky className="w-10 h-10 text-white" />
        </a>
        <a
