  ...
  return (
    <>
      ...
      <div className="w-full bg-gradient-to-b from-transparent to-30% from-0% to-[#ffb600]">
        <div className="w-full gap-3 md:gap-4 flex flex-wrap items-stretch justify-center">
          <Link
            to="youtube"
          ...
          >
            <span className="hidden lg:inline text-3xl leading-loose font-serif align-middle text-left pl-2.5 text-white text-stroke-sm">
              Youtube
            </span>
          </Link>
          <Link
