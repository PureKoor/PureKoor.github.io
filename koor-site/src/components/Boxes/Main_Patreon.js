...
function Main_Patreon() {
  return (
    ...
    >
      <div className="grid grid-cols-1 md:grid-cols-3 gap-5 w-full my-5">
        <a
        ...
        >
          <div
            className="text-4xl inline text-white text-stroke-sm font-serif flex items-center align-middle h-full bg-[#4d0000] bg-opacity-25 md:ml-5 rounded-3xl
          hover:bg-[#0e5096] duration-150 hover:bg-opacity-65 transition-all ease-out hover:scale-105 "
          >
            <div className="w-full">
              <div className="text-center">
                <p className="mx-3 my-1 text-4xl md:text-7xl">$1 Perks</p>
        ...
        >
         ...
         hover:bg-[#027521] duration-150 hover:bg-opacity-65 transition-all ease-out hover:scale-105"
          >
            <div className="w-full">
              <div className="text-center">
                <p className="mx-3 my-1 text-4xl md:text-7xl">$4 Perks</p>
        ...
        <div
          className="md:row-start-2 md:col-start-2 border-2 border-double rounded-3xl border-[#d98200] bg-[#4d0000] bg-opacity-50 m-1
