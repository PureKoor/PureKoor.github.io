...
function Main_Patreon() {
  return (
    <div
      id="support"
      className="bg-[url('../public/assets/Patreon_FW_2021Apr29_NierReplicant_TXless_HiRes.png')] max-w-screen-xl  w-full bg-cover bg-top bg-no-repeat"
    >
      <div className="flex flex-row justify-between items-start gap-5 my-5 flex-wrap w-full">
        <div>
          <p className="text-xl font-regular font-serif text-white text-stroke-sm">
