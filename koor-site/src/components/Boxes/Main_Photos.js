function Main_FWA26_TF() {
  return (
    <div
      className="max-w-screen-xl grid grid-cols-1 lg:grid-cols-2 items-center w-full
      bg-[url('../public/assets/bg_box/pexels-eberhardgross-572897_mountains.webp')] bg-cover bg-center bg-no-repeat"
    >
      <div className="rounded-xl border-4 border-white mt-3 mb-1 mx-3 lg:my-3 lg:mr-0 overflow-hidden">
        <a
          href="https://www.furtrack.com/user/PureKoor/"
          target="_blank"
          rel="noopener noreferrer"
        >
          <img
            src="/assets/Photography/Photos_RedwoodCity.webp"
            alt="FWA 2026"
